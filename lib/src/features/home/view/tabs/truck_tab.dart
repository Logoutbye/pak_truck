  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      slivers: [
        ...
        // Sliver for the Section Header
        SliverToBoxAdapter(
          child: buildSectionHeader(context,
              title: 'Used Truck For Sale', onViewAllPressed: () {}),
        ),

        // Sliver for the VechileCard
        SliverToBoxAdapter(
          child: VechileCard(
            cardWidthRatio: 0.6,
            items: [
        ...
        // Sliver for the vechileCard2
        SliverToBoxAdapter(
          child: vechileCard2(context, newsItems),
        ),
      ],
    );
  }
