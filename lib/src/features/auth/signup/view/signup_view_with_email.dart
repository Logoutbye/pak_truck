...
class SignUpViewWithEmail extends StatefulWidget {
  const SignUpViewWithEmail({super.key});

  @override
  State<SignUpViewWithEmail> createState() => _SignUpViewWithEmailState();
}

class _SignUpViewWithEmailState extends State<SignUpViewWithEmail> {
                    ...
                    return RoundButton(
                      ...
                      onPress: () {
                        if (_nameController.text.isEmpty) {
                          ...
                          provider.signupWithEmail(context, data).then((value) {
                            Navigator.pushNamed(
