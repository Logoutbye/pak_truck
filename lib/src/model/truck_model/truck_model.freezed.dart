...
mixin _$TruckModel {
  ...
  int get price =>
      throw _privateConstructorUsedError; // ✅ Fix: Expect an integer
  int get modelYear =>
      throw _privateConstructorUsedError; // ✅ Fix: Expect an integer
...
abstract class _$$TruckModelImplCopyWith<$Res>
  ...
  factory _$$TruckModelImplCopyWith(
          _$TruckModelImpl value, $Res Function(_$TruckModelImpl) then) =
...
class __$$TruckModelImplCopyWithImpl<$Res>
  ...
  __$$TruckModelImplCopyWithImpl(
      _$TruckModelImpl _value, $Res Function(_$TruckModelImpl) _then)
      : super(_value, _then);
...
abstract class _TruckModel implements TruckModel {
  const factory _TruckModel(
      ...
      final String adType,
      final String postedBy,
      final String createdAt}) = _$TruckModelImpl;
  ...
  @override
  int get price; // ✅ Fix: Expect an integer
  @override
  int get modelYear; // ✅ Fix: Expect an integer
// @Default('') String price, // Price
// @Default('') String modelYear, // Year of the truck
  @override
